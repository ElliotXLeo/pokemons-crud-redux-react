...
import { submitPokemonsForm } from '../../redux/actions/pokemonsActions';
...
const PokemonsForm = () => {
  ...
  const { pokemon } = useSelector(state => state.pokemonsReducers);
  ...
  return (
    <Formik
      ...
      onSubmit={async (values, actions) => {
        await dispatch(submitPokemonsForm(values));
